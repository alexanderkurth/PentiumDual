...
#include "PentiumDual/PatrolPath.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	...
	PENTIUMDUAL_API UClass* Z_Construct_UClass_APatrolPath();
...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_patrol_points_MetaData[];
#endif
		static const UE4CodeGen_Private::FArrayPropertyParams NewProp_patrol_points;
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_patrol_points_Inner;
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_APatrolPath_Statics::NewProp_patrol_points_MetaData[] = {
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_APatrolPath_Statics::NewProp_patrol_points = { "patrol_points", nullptr, (EPropertyFlags)0x0040000000000005, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(APatrolPath, patrol_points), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_APatrolPath_Statics::NewProp_patrol_points_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_APatrolPath_Statics::NewProp_patrol_points_MetaData)) };
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_APatrolPath_Statics::NewProp_patrol_points_Inner = { "patrol_points", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_APatrolPath_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_APatrolPath_Statics::NewProp_patrol_points,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_APatrolPath_Statics::NewProp_patrol_points_Inner,
	};
	...
	IMPLEMENT_CLASS(APatrolPath, 723763529);
	template<> PENTIUMDUAL_API UClass* StaticClass<APatrolPath>()
	{
		return APatrolPath::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_APatrolPath(Z_Construct_UClass_APatrolPath, &APatrolPath::StaticClass, TEXT("/Script/PentiumDual"), TEXT("APatrolPath"), false, nullptr, nullptr, nullptr);
